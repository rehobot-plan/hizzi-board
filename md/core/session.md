...
**예외 — todo.md·done.md는 공장이 매 1-6에서 직접 업데이트한다.** 완료된 TODO는 todo.md 해당 줄 삭제, 신규 TODO는 후보 큐 추가, 완료 작업은 done.md에 한 줄 append. 도메인 층 자율 원칙과 정합하며, 세션 종료 단계 2에서 정돈된다. 세션 단위 서사·교훈은 쓰지 않는다 (박제 필요분은 principles.md / MEMORY.md 기존 경로).
